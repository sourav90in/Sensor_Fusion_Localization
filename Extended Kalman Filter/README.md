...
In this project Kalman filtering is being utilized to estimate the state of a moving object of interest(bicycle) with noisy lidar and radar measurements. The LIDAR measurement data has been preprocessed using 3D Cloud Pre-processing techniques and provided for this project by Udacity.
